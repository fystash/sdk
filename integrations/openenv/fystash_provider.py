...
Firecracker rooms (Loop 94). Prefer upstream after merge:
https://github.com/huggingface/OpenEnv/pull/1014
...
try:  # pragma: no cover - optional when openenv installed
    from openenv.core.containers.runtime.providers import ContainerProvider
except ImportError:  # standalone / pre-merge vendor path
